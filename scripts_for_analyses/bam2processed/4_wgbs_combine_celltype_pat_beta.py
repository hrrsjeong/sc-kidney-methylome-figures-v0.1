...
celltype_pat_out = "celltype_pat"
celltype_beta_out = "celltype_beta"
...
for celltype in celltypes:
    ...
    #beta_out = f"{celltype_beta_out}/{celltype}"
    ...
    run_systemstr += '" '+sbatch_option+f' -e {cwd}/err_combine_pat__{celltype}.log -o {cwd}/out_combine_pat__{celltype}.log'
